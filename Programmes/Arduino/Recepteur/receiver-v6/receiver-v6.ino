...
// Fonction permettant de faire tourner les moteurs côté gauche.
void motorLeft(int vitesse)
{
...
// Fonction permettant de faire tourner les moteurs côté droit.
void motorRight(int vitesse)
{
